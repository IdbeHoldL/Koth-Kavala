...
zlt_fnc_civvehs = {
	...
	_classes = ["C_Offroad_01_F","C_Hatchback_01_F","C_Hatchback_01_sport_F","C_SUV_01_F"];
...
//					_x setside east;
	...
	
	{
		...
		_ent = ( (_pos) nearEntities [["C_Offroad_01_F","C_Hatchback_01_F","C_Hatchback_01_sport_F","C_SUV_01_F"], 300] );
		{
