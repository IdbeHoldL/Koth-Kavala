...
if(_side == "bluf") then
{
	...
	spawntruck_blu addMPEventHandler ["mpkilled",{"blu" spawn vehicle_fnc_spawnTruck}];
...
if(_side == "redf") then
{
	...
	spawntruck_red addMPEventHandler ["mpkilled",{"red" spawn vehicle_fnc_spawnTruck}];
...
{	
	...
	spawntruck_ind addMPEventHandler ["mpkilled",{"ind" spawn vehicle_fnc_spawnTruck}];
